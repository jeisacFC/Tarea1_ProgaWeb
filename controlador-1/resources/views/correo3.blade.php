<x-layouts.app title="Correo 3">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <flux:heading size="xl">Información de Estudiantes de Programación Web 2026 - versión 3</flux:heading>

        @php
            $estudiantes = [
                ['Nombre' => 'Pablo Alvarado', 'Edad' => 22, 'Carrera' => 'Ing. Electrica'],
                ['Nombre' => 'Cristopher Gonzalez', 'Edad' => 22, 'Carrera' => 'Negocios'],
                ['Nombre' => 'Siandi Araya', 'Edad' => 21, 'Carrera' => 'Ing. Ambiental'],
            ];
        @endphp
